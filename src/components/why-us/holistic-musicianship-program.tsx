  ...
  return (
    <section>
      <div className='container-fluid'>
        ...
        />
        <div className='bg-secondary-rhapsody xl:mt-[220px] lg:mt-25 md:mt-44 mt-[540px] xl:mb-20 mb-0'>
          <div className='container'>
            <div className='flex lg:flex-row flex-col items-center justify-between gap-[66px]'>
              ...
              >
                <h2 className='text-primary-rhapsody font-farro text-3xl 2sm:text-4xl font-bold leading-120 mb-14 max-w-[400px] mt-10'>
                  How It Works
                </h2>
                <p className=' text-primary-foreground-rhapsody '>
                ...
                <p className='text-primary-foreground-rhapsody mt-7 mb-10'>
